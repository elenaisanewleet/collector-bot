...
ERROR_REASONS: dict[str, str] = {
    ...
    "never_started": "поставщик не взялся за запрос",
...
_SPOKEN_CODES: dict[str, str] = {
    ...
    "never_started": "не проверено — поставщик не взялся за запрос, стоит повторить позже",
}
...
NO_SOURCE_STATE = SourceState(SourceStateCode.NO_SOURCE, "источника нет", "∅", False)
