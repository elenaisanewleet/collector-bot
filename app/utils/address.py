...
«объекта нет». Одна и та же квартира спрошена в ЕГРН трижды, и все три раза
нашлась:

* «г Москва, проезд Тестовый,8,139» — как прислал поставщик;
* «Москва г Москва, Тестовый проезд, д 8, кв 139» — он же от другой конторы;
* «г Москва, Тестовый проезд, д 8, кв 139» — **то, что собирает эта функция.**

Третий замер и есть разрешение: собранную строку источник принимает. Первые два
показывают, почему он её принимает — ему безразличны порядок слов, маркеры
«д»/«кв» против голых чисел и даже дважды названный город.
