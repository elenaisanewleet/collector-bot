...
#:
#: Говорит ровно то же, что первый экран: на какой вопрос бот отвечает, что
#: нажать и чем «не проверено» отличается от «чисто». Ни источников, ни базы по
#: имени: из чего собран ответ, показывает экран «Откуда данные» — тому, кто
#: спросил. Это первое, что видит человек, и место для рекламы источников тут
#: самое неподходящее.
BOT_DESCRIPTION = (
    "Проверяю ваших должников и отвечаю на один вопрос: стоит ли подавать и "
    "платить пошлину.\n\n"
