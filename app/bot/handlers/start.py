...
2️⃣ Введите то, что бот попросит: ФИО с датой рождения, номер договора или госномер
3️⃣ Получите вердикт — иск, судебный приказ, проверить руками или не подавать — \
с суммой пошлины и ссылкой на полный отчёт
