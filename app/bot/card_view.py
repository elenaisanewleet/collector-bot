...
NOT_IN_EXPORT = "Искал по {key} — в вашей выгрузке никого нет."
...
NOT_IN_EXPORT_TRY = "Попробуйте госномер, фамилию с именем или номер договора."
...
OPTIONS: tuple[_Option, ...] = (
    ...
    _Option(
        ...
        "Телефон",
        "",
        "поднимет строку из вашей выгрузки: там ФИО, договор и машина",
    ),
    _Option(Field.CONTRACT, "Договор", "", "поднимет строку из вашей выгрузки"),
    _Option(Field.ADDRESS, "Адрес", "", "поднимет строку из вашей выгрузки"),
)
...
HINTS: dict[str, str] = {
    ...
    Field.CONTRACT.value: (
        ...
        "поднимет строку из вашей выгрузки с ФИО, долгом и машиной."
    ),
    Field.ADDRESS.value: (
