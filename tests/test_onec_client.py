...
def test_injected_predicate_stays_inside_one_string_literal() -> None:
    ...
    # Кавычка удвоена — ``%27%27``, а не ``%27``. Ровно этим враждебный ввод и
    # остаётся текстом внутри литерала: с одинарной он закрыл бы его и дописал
    # второй предикат, вытащив из базы посторонних людей.
    expected = "$filter=%D0%9F%D0%BE%D0%BB%D0%B5%20eq%20'x%27%27%20or%201%20eq%201%20or%20%27%27'"
