    ...
    payload = build_workbook(
        {
            ...
            "Выгрузка_1С": [["ФИО", "Телефон"], ["Иванов Иван Иванович", "+79990001122"]],
    ...
    payload = build_workbook(
        {
            "Лист": [
                ...
                [],
                ["ФИО", "Телефон"],
                ["Иванов Иван Иванович", "+79990001122"],
            ]
        }
    )
...
async def test_excel_and_csv_import_to_the_same_rows(import_service: ImportService) -> None:
    ...
    rows: list[list[Any]] = [
        ...
        ["Иванов Иван Иванович", "+79990001122", dt.datetime(1958, 1, 19), 26997],
    ...
    csv_text = "\n".join(
        [
            "ФИО,Телефон,Дата_рождения,Долг",
            "Иванов Иван Иванович,+79990001122,19.01.1958,26997",
